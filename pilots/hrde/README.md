...
- Invocations
  ...
  - 2026 pilot results and notes will appear here
- Primary components
...
- Additional features (added in 2017)
  ...
  - When shift key is depressed, user can freely drag cursor around on the HRD
  - Help button is emphasized in display until clicked on for first time (to encourage usage).
  - Number box spinner arrows for luminosity adjust so shifts are linear across range (even though axis is logarithmic)
- Possible library and template features
  - Masthead with sim title and buttons for reset, help, and about (WCAG AA compliant)
