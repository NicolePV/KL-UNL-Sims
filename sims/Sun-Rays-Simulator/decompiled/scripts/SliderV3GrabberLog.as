...
Object.registerClass("SliderV3GrabberLog",SliderV3GrabberClass);
...
p.onMouseMoveFunc = function()
{
   ...
   _loc1_._parent.value = Math.pow(10,_loc2_ * 0.003);
   _loc1_._parent.callHandler();
   updateAfterEvent();
};
p.onRelease = p.onReleaseOutside = function()
{
   this._parent.inUse = false;
