function SliderV3Class()
{
   ...
   _loc1_._valueLabel.label_text.textColor = _loc1_.txtColor;
...
Object.registerClass("SliderV3log",SliderV3Class);
...
{
   var _loc1_ = this;
   _loc1_._grabber._x = Math.log(_loc1_._value) / 2.302585092994046 * (2 * _loc1_._hw / 0.45) / _loc1_._scale - _loc1_._hw;
};
p.getMin = function()
{
   return this._min;
