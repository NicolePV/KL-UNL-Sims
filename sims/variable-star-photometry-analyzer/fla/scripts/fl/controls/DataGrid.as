package fl.controls
{
   ...
   public class DataGrid extends SelectableList implements IFocusManagerComponent
   {
      ...
      protected function handleHeaderResizeDown(param1:MouseEvent) : void
      {
         ...
         _loc3_ = Number(dragHandlesMap[_loc2_]);
      ...
      protected function findNextEnterItemRenderer(param1:KeyboardEvent) : void
      {
         ...
         _loc2_ = int(_editedItemPosition.rowIndex);
         _loc3_ = int(_editedItemPosition.columnIndex);
      ...
      protected function calculateAvailableHeight() : Number
      {
         ...
         _loc2_ = _horizontalScrollPolicy == ScrollPolicy.ON || _horizontalScrollPolicy == ScrollPolicy.AUTO && _maxHorizontalScrollPosition > 0 ? 15 : 0;
      ...
      public function set rowCount(param1:uint) : void
      {
         ...
         _loc3_ = _horizontalScrollPolicy == ScrollPolicy.ON || _horizontalScrollPolicy == ScrollPolicy.AUTO && hScrollBar ? 15 : 0;
