...
p.setTitle = function(arg)
{
   ...
   this.displayText(arg,{depth:10,vAlign:"top",hAlign:"left",x:this.titleXPosition,y:this.titleYPosition - this.titleBarHeight,embedFonts:true,textFormat:this.titleTextFormat});
};
p.recenter = function()
{
