   ...
   public class ProtoSliderLogic
   {
      ...
      public function getValueObjectFromValue(param1:Number) : Object
      {
         ...
         else
         {
            ...
            _loc9_ = 0;
            while(_loc9_ < this._finiteSet.length)
            {
               _loc5_ = Math.abs(this._finiteSet[_loc9_] - param1);
               if(_loc5_ < _loc8_)
               {
                  _loc6_ = Number(this._finiteSet[_loc9_]);
                  _loc7_ = _loc9_;
                  _loc8_ = _loc5_;
               }
               _loc9_++;
      ...
      public function getIncrementedValueObject(param1:*, param2:int) : Object
      {
         ...
         else if(this._rMode == 1)
         {
            ...
            while(_loc9_ < this._finiteSet.length)
            {
               _loc10_ = Math.abs(this._finiteSet[_loc9_] - param1.value);
               if(_loc10_ < _loc12_)
               {
                  _loc11_ = _loc9_;
                  _loc12_ = _loc10_;
            ...
            else if(_loc9_ >= this._finiteSet.length)
            {
               _loc9_ = this._finiteSet.length - 1;
            }
            _loc3_ = this.getValueObjectFromValue(this._finiteSet[_loc9_]);
         }
         return _loc3_;
      }
      ...
      public function setRangeType(param1:String, param2:Array = null) : void
      {
         ...
         else if(param1 == "finite set")
         {
            ...
            {
               this._finiteSet.push(param2[_loc3_]);
               _loc3_++;
            }
            this._finiteSet.sort(Array.NUMERIC);
            this._minV = this._finiteSet[0];
            this._maxV = this._finiteSet[this._finiteSet.length - 1];
            this.calculateScale();
         }
         this.refresh();
      }
      ...
      public function toString() : String
      {
         ...
         _loc1_ += " _rMode: " + String(this._rMode) + "\n";
