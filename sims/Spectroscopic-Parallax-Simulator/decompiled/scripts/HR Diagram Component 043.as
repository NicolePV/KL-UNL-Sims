function HRDiagramComponentClass043()
{
...
var p = HRDiagramComponentClass043.prototype = new MovieClip();
Object.registerClass("HR Diagram Component 043",HRDiagramComponentClass043);
...
p.drawYScale = function(side, scaleType)
{
   ...
   var _loc24_ = this[_loc17_ + "AxisLabel"];
   var _loc22_ = this[_loc17_ + "LabelSpacing"];
   var _loc14_ = this[_loc17_ + "LabelMultiple"];
   var _loc19_ = this[_loc17_ + "AxisLabelSpacing"];
   var _loc20_ = this.tickmarkLabelTextFormat;
   var _loc25_;
   var _loc8_;
   var _loc18_;
   var _loc5_;
   if(side == "left")
   {
      ...
      var labelSettings = {mc:_loc5_,textFormat:_loc20_,embedFonts:true,sizeRatio:1.2,x:_loc25_,y:y,vAlign:"center",hAlign:"right",extraSpacing:2};
   }
   else
   {
      if(side != "right")
      ...
      _loc25_ = this.plotWidth + _loc22_;
      _loc8_ = this.plotWidth;
      _loc18_ = 1;
      _loc5_ = this.scalesMC.rightMC;
      var labelSettings = {mc:_loc5_,textFormat:_loc20_,embedFonts:true,sizeRatio:1.2,x:_loc25_,y:y,vAlign:"center",hAlign:"left",extraSpacing:2};
   }
   _loc5_._alpha = this.borderAndScalesAlpha;
   var _loc9_ = 3 * _loc18_ + _loc8_;
   var _loc12_ = 7 * _loc18_ + _loc8_;
   var axisMin = this._yAxisMin;
   var height = this.plotHeight;
   var scale = (- this.plotHeight) / (this._yAxisMax - this._yAxisMin);
   var _loc21_ = this.yPropertyCapNamesList[this._yAxisType];
   this.getScaleType = this["get" + scaleType + "From" + _loc21_];
   this.getAxisType = this["get" + _loc21_ + "From" + scaleType];
   var dispText = this.displayText;
   var _loc26_;
   var _loc27_;
   if(this._yAxisType == 0)
   {
      ...
      if(scaleType == "LogLum")
      {
         _loc26_ = this.getScaleType(this._yAxisMin,0);
         _loc27_ = this.getScaleType(this._yAxisMax,0);
      }
      else
      {
         _loc26_ = this.getScaleType(this._yAxisMax,0);
   ...
   var _loc16_ = Math.floor(_loc26_);
   var _loc13_ = Math.ceil(_loc27_);
   ...
   this.addTextToWrapperMC(_loc10_,_loc24_,this.axisLabelTextFormat,this.displayText,this.drawCircle,true,false);
   if(_loc18_ < 0)
   {
      _loc10_._y = (- this.plotHeight + _loc10_._width) / 2;
      _loc10_._rotation = -90;
      _loc10_._x = - _loc19_ - _loc10_._width / 2;
   }
   else
   {
      _loc10_._y = (- this.plotHeight - _loc10_._width) / 2;
      _loc10_._rotation = 90;
      _loc10_._x = this.plotWidth + _loc19_ + _loc10_._width / 2;
   }
   delete this.getY;
...
{
   var _loc4_ = {};
   var _loc15_ = tf.getTextExtent("8");
   if(System.capabilities.os.toLowerCase().indexOf("mac") != -1)
   {
      _loc15_.width = 0.05 * _loc15_.width;
      _loc15_.height = 0.05 * _loc15_.height;
   }
   ...
   var _loc8_ = _loc15_.height - _loc7_;
   ...
   if(showBackground)
   {
      ...
      _loc13_.moveTo(0,0);
      _loc13_.lineTo(_loc19_,0);
      _loc13_.lineTo(_loc19_,_loc18_);
      _loc13_.lineTo(0,_loc18_);
      _loc13_.lineTo(0,0);
      _loc13_.endFill();
   }
   return wmc;
