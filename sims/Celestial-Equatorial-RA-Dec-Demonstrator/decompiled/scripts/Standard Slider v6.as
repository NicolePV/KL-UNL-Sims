function StandardSliderClassV6()
{
   ...
   _loc1_.grabberMC.onSetFocus = function()
   {
      ...
      _loc1_.onMouseMove = _loc1_.onKillFocus;
   ...
   _loc1_.grabberMC.onKeyDownFunc = function()
   {
      var _loc3_ = this;
   ...
   delete _loc1_.value;
   if(_loc1_.showField == undefined)
   {
      _loc1_.showField = true;
   }
   ...
   if(_loc1_.sliderRange == undefined)
   {
      ...
      {
         _loc1_.sliderRange = _loc1_._width - _loc1_.barSpacing - 2 * _loc1_.barMargin;
      }
   ...
   {
      initObj.minParameter = _loc1_.barSpacing + _loc1_.barMargin;
   }
...
p.updateParameterRange = function()
{
   ...
   if(_loc1_.showField)
   {
      _loc2_ = _loc1_.fieldWidth + _loc1_.barSpacing + _loc1_.barMargin;
   }
   else
   {
      _loc2_ = _loc1_.barSpacing + _loc1_.barMargin;
   }
...
p.updateBarPosition = function()
{
   ...
   {
      _loc1_.barMC._x = _loc1_.barSpacing;
   }
};
p.updateLabelAndUnitsPositions = function()
{
   ...
   {
      _loc1_.labelTextMC._x = - _loc1_.labelTextMC.totalWidth;
      _loc1_.unitsTextMC._x = 0;
   }
};
p.updateFieldVisibility = function()
{
   var _loc1_ = this;
   _loc1_.fieldMC._visible = _loc1_.showField;
   _loc1_.valueField._visible = _loc1_.showField;
};
