function ScientificNotationNumberClass()
{
   var _loc1_ = this;
   ...
   switch(_loc1_.initJustification)
   {
      case "none":
         _loc1_._justificationType = 0;
         break;
      case "left":
         _loc1_._justificationType = 2;
         break;
      case "right":
         _loc1_._justificationType = 3;
         break;
      default:
         _loc1_._justificationType = 1;
   }
   _loc1_._value = parseFloat(_loc1_.initValue);
   _loc1_.setNumberOfSigFigs(_loc1_.initSigFigs);
}
var p = ScientificNotationNumberClass.prototype = new MovieClip();
Object.registerClass("Scientific Notation Number",ScientificNotationNumberClass);
p.textMargin = 4;
p.getValue = function()
{
   var _loc2_ = this;
...
p.setJustification = function(arg)
{
   var _loc1_ = this;
   switch(arg)
   {
...
p.setNumberOfSigFigs = function(arg)
{
   var _loc1_ = this;
   _loc1_._sigFigs = Math.abs(parseInt(arg));
   if(!isFinite(_loc1_._sigFigs) || isNaN(_loc1_._sigFigs) || _loc1_._sigFigs == 0)
   {
      _loc1_._sigFigs = 3;
   }
   else if(_loc1_._sigFigs > 15)
   {
      _loc1_._sigFigs = 15;
   }
