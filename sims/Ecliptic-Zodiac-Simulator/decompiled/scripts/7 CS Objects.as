function CSObjectsClass(parent, name, id, linkageName, position, initObject)
{
   ...
   if(typeof position != "object")
   {
      ...
      _loc1_.instance._visible = false;
   }
   else
   {
...
p.addObject = function(linkageName, name, position, initObject)
{
   ...
   _loc1_[name] = new CSObjectsClass(_loc1_,name,id,linkageName,position,initObject);
   _loc1_._objectList.push({id:id,name:_loc1_[name]});
};
