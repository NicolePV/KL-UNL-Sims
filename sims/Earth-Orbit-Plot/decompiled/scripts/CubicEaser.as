package
{
   public class CubicEaser
   {
      ...
      protected function doComputations() : void
      {
         ...
         this.splinePointsList.sortOn("x",Array.NUMERIC);
         var _loc5_:Array = this.splinePointsList;
      ...
      {
         this.setTarget(0,param1,1,param1);
      }
      
      public function setTarget(param1:Number, param2:*, param3:Number, param4:Number) : Object
      {
         if(!(param2 is Number))
         {
            param2 = this.getValue(param1);
            this.slope0 = this.getDerivative(param1);
         }
         else
         {
            this.slope0 = 0;
         }
         this.splinePointsList = [{
            "x":param1,
            "y":param2
         },{
            "x":param3,
         ...
         this.doComputations();
         this.targetTime = param3;
         this.targetValue = param4;
         return {
      ...
      {
         var _loc2_:Array = this.parametersList;
