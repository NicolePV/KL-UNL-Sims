function CelestialSphereClass()
{
   ...
   _loc1_.createEmptyMovieClip("_bEL",_loc2_ - 6);
   _loc1_.createEmptyMovieClip("_bOSB",_loc2_ - 5);
   _loc1_.createEmptyMovieClip("_bOSA",_loc2_ - 4);
   _loc1_.createEmptyMovieClip("_bOSF",_loc2_ - 3);
   _loc1_.createEmptyMovieClip("_bF",_loc2_ - 2);
   ...
   _loc1_.createEmptyMovieClip("_iLA",4 * _loc2_ - 6);
   _loc1_.createEmptyMovieClip("_fISB",4 * _loc2_ - 5);
   _loc1_.createEmptyMovieClip("_fISA",4 * _loc2_ - 4);
   _loc1_.createEmptyMovieClip("_fISF",4 * _loc2_ - 3);
   _loc1_.createEmptyMovieClip("_fF",4 * _loc2_ - 2);
