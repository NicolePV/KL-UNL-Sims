function BasketballRotatorClass()
{
   this.attachMovie("BasketballSequence","_sequence",1);
   this._sequence.stop();
...
var p = BasketballRotatorClass.prototype = new MovieClip();
Object.registerClass("BasketballRotator",BasketballRotatorClass);
p._frames = 79;
