...
p.initialize = function()
{
   ...
   var _loc4_ = this.contentMC._height;
   ...
   this.maxY = this.bottomLimit - this.buffer - _loc4_;
   ...
   _loc5_.beginFill(16711680,0);
   _loc5_.moveTo(0,- _loc2_);
   _loc5_.lineTo(0,_loc4_);
   _loc5_.lineTo(_loc3_,_loc4_);
   _loc5_.lineTo(_loc3_,- _loc2_);
   _loc5_.lineTo(0,- _loc2_);
   _loc5_.endFill();
   _loc5_ = this.titleBarBackgroundMC;
   _loc5_.beginFill(this.titleBarColor);
   _loc5_.moveTo(0,0);
   ...
   _loc5_.lineTo(0,0);
   _loc5_.endFill();
   _loc5_ = this.contentMaskMC;
   _loc5_.beginFill(16711680,10);
   _loc5_.moveTo(0,0);
   _loc5_.lineTo(_loc3_,0);
   _loc5_.lineTo(_loc3_,_loc4_);
   _loc5_.lineTo(0,_loc4_);
   ...
   this._y = this.topLimit + (this.bottomLimit - this.topLimit) / 2 - (_loc4_ - _loc2_) / 2;
};
p.hide = function()
{
   this._visible = false;
