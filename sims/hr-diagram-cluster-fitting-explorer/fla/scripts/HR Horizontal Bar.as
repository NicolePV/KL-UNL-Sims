...
{
   var diagramMC = this._parent.diagramMC;
   this._x = diagramMC._x;
   this._y = diagramMC._y;
   var _loc5_ = diagramMC.plotWidth;
   var _loc9_ = 2;
   var _loc6_ = 3;
   var _loc7_ = 6316128;
   var _loc8_ = 4210752;
   ...
   this.barMC.diagramMC = diagramMC;
   ...
   this.barMC.onMouseMoveFunc = function()
   {
      ...
      else if(_loc2_ < - this.diagramMC.plotHeight)
      {
         _loc2_ = - this.diagramMC.plotHeight;
      }
      this._y = _loc2_;
...
{
   this.barMC._y = (- this.barMC.diagramMC.plotHeight) / 2;
};
p.updateValues = function()
{
   var _loc3_ = this._parent.diagramMC.plotHeight / (this._parent.diagramMC._yAxisMax - this._parent.diagramMC._yAxisMin);
   var _loc2_ = this._parent.diagramMC._yAxisMax + this.barMC._y / _loc3_;
   var _loc4_ = _loc2_ + this._parent.diagramMC.distanceModulus;
