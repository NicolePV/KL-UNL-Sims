...
{
   this.createEmptyMovieClip("backAxis",0);
   this.createEmptyMovieClip("globe",10);
   this.createEmptyMovieClip("nightSide",15);
   this.createEmptyMovieClip("frontAxis",20);
   this.globe.createEmptyMovieClip("shores",30);
   this.setFills("GlobeComponentLand","GlobeComponentWater");
   this._parent._parent.addLine("PrecessingGlobeSouthPoleAxis",{thickness:2,color:255,alpha:100},{az:0,alt:0,r:0},{az:0,alt:0,r:1.5});
   this._parent._parent.addLine("PrecessingGlobeNorthPoleAxis",{thickness:2,color:16711680,alpha:100},{az:0,alt:0,r:0},{az:0,alt:0,r:1.5});
   this.setAxisStyle(2,5263440,100);
   this._c = {};
...
{
   this.axisExtent = arg;
   this._parent._parent.PrecessingGlobeSouthPoleAxis.visible = this.axisExtent > 1;
   this._parent._parent.PrecessingGlobeNorthPoleAxis.visible = this.axisExtent > 1;
   trace(this._parent._parent.PrecessingGlobeNorthPoleAxis.visible);
};
p.setFills = function(landFill, waterFill)
{
   this.globe.attachMovie(waterFill,"water",10);
   this.globe.attachMovie(landFill,"land",20);
   this.globe.land.setMask(this.globe.shores);
};
p.setSunDirection = function(arg)
{
   this._sunDir = {};
   this._parent._parent.parsePointInput(arg,this._sunDir);
   if(this._sunDir.sys == null)
   {
      this._skipShading = true;
   }
   else
   {
      this._skipShading = false;
   }
};
p.updateShading = function()
{
   var _loc10_ = this.nightSide;
   _loc10_.clear();
   if(this._skipShading)
   {
      return undefined;
   }
   var _loc18_ = this._sunDir;
   var _loc17_ = {};
   if(_loc18_.sys == 0 || _loc18_.sys == -1)
   {
      this._parent._parent.WtoSz(_loc18_,_loc17_);
   }
   else
   {
      if(_loc18_.sys != 1)
      ...
      this._parent._parent.CtoSz(_loc18_,_loc17_);
   }
   _loc10_._rotation = 57.29577951308232 * Math.atan2(_loc17_.x,- _loc17_.y);
   var _loc16_ = (- _loc17_.z) / Math.sqrt(_loc17_.x * _loc17_.x + _loc17_.y * _loc17_.y + _loc17_.z * _loc17_.z);
   var _loc15_ = 4;
   var _loc4_ = 3.141592653589793 / _loc15_;
   var _loc19_ = _loc4_ / 2;
   var _loc6_ = Math.cos;
   var _loc7_ = Math.sin;
   var _loc5_ = this._radius;
   var _loc8_ = _loc5_ / _loc6_(_loc19_);
   _loc10_.moveTo(_loc5_,0);
   _loc10_.lineStyle(1,16711680,0);
   _loc10_.beginFill(0,40);
   var _loc3_ = _loc4_;
   var _loc2_ = _loc4_ - _loc19_;
   var _loc9_ = 0;
   var _loc14_;
   var _loc13_;
   var _loc12_;
   ...
   {
      _loc14_ = _loc5_ * _loc6_(_loc3_);
      _loc13_ = _loc16_ * _loc5_ * _loc7_(_loc3_);
      _loc12_ = _loc8_ * _loc6_(_loc2_);
      _loc11_ = _loc16_ * _loc8_ * _loc7_(_loc2_);
      _loc10_.curveTo(_loc12_,_loc11_,_loc14_,_loc13_);
      _loc3_ += _loc4_;
      _loc2_ += _loc4_;
      _loc9_ = _loc9_ + 1;
...
p.setAxisStyle = function(thickness, color, alpha)
{
   ...
   this._parent._parent.PrecessingGlobeSouthPoleAxis.setStyle(this.axisThickness,this.axisColor,this.axisAlpha);
   this._parent._parent.PrecessingGlobeNorthPoleAxis.setStyle(this.axisThickness,this.axisColor,this.axisAlpha);
};
p.setShowAxes = function(arg)
{
   this._skipAxes = !arg;
   if(this._skipAxes)
   {
      this.frontAxis.clear();
      this.backAxis.clear();
      this._parent._parent.PrecessingGlobeSouthPoleAxis.visible = false;
      this._parent._parent.PrecessingGlobeNorthPoleAxis.visible = false;
   }
   else
   {
      this._parent._parent.PrecessingGlobeSouthPoleAxis.visible = true;
      this._parent._parent.PrecessingGlobeNorthPoleAxis.visible = true;
   }
};
p.updateAxes = function()
{
   ...
   var _loc6_ = this._c;
   var _loc2_ = this._parent._parent._c;
   var _loc3_ = this._radius * this.globe._yscale / (_loc2_.r * 100);
   ...
   var _loc9_ = _loc3_ * (_loc2_.b6 * _loc6_.q2 + _loc2_.b7 * _loc6_.q5 + _loc2_.b8 * _loc6_.q8);
   if(this.axisExtent <= 1)
   {
      _loc3_ /= this.axisExtent;
   }
   var _loc11_ = 100 * _loc2_.r / (this._radius * this._yscale);
   var _loc8_;
   if(_loc9_ > 0)
   {
      _loc8_ = this.frontAxis;
      _loc8_.clear();
      _loc8_.lineStyle(this.axisThickness,this.axisColor,this.axisAlpha);
      _loc8_.moveTo(_loc5_,_loc4_);
      _loc8_.lineTo(_loc5_ / _loc3_,_loc4_ / _loc3_);
      _loc8_ = this.backAxis;
      _loc8_.clear();
      _loc8_.lineStyle(this.axisThickness,this.axisColor,this.axisAlpha);
      _loc8_.moveTo(- _loc5_,- _loc4_);
      _loc8_.lineTo((- _loc5_) / _loc3_,(- _loc4_) / _loc3_);
   ...
   var _loc15_ = (_loc2_.a0 * _loc5_ + _loc2_.a3 * _loc4_ + _loc2_.a6 * _loc9_) / _loc2_.r2;
   var _loc14_ = (_loc2_.a1 * _loc5_ + _loc2_.a4 * _loc4_ + _loc2_.a7 * _loc9_) / _loc2_.r2;
   var _loc13_ = (_loc2_.a5 * _loc4_ + _loc2_.a8 * _loc9_) / _loc2_.r2;
   var _loc7_ = this.axisExtent / _loc3_;
   this.ncp = {x:_loc15_ / _loc3_,y:_loc14_ / _loc3_,z:_loc13_ / _loc3_,system:"horizon"};
   this.scp = {x:(- _loc15_) / _loc3_,y:(- _loc14_) / _loc3_,z:(- _loc13_) / _loc3_,system:"horizon"};
   this._parent._parent.PrecessingGlobeNorthPoleAxis.setPoints(this.ncp,{x:_loc15_ * _loc7_,y:_loc14_ * _loc7_,z:_loc13_ * _loc7_,system:"horizon"});
   this._parent._parent.PrecessingGlobeNorthPoleAxis.update();
   this._parent._parent.PrecessingGlobeSouthPoleAxis.setPoints(this.scp,{x:(- _loc15_) * _loc7_,y:(- _loc14_) * _loc7_,z:(- _loc13_) * _loc7_,system:"horizon"});
   this._parent._parent.PrecessingGlobeSouthPoleAxis.update();
   if(this._traceOn)
   {
      trace("globe axis time: " + (getTimer() - _loc10_));
   }
};
p.update = function()
{
   var _loc42_ = getTimer();
   ...
   var _loc32_ = this._c;
   var _loc30_ = this._parent._parent._c;
   var _loc40_ = this._radius / _loc30_.r;
   ...
   if(this._traceOn)
   {
      trace("globe time: " + (getTimer() - _loc42_));
   }
};
p.setPrecessionAngle = function(arg)
{
   ...
   var _loc5_ = Math.cos(arg);
   var _loc4_ = Math.sin(arg);
   var _loc2_ = this._c;
   _loc2_.p0 = _loc5_;
   _loc2_.p1 = - _loc4_;
   _loc2_.p3 = _loc4_ * 0.91706;
   _loc2_.p4 = _loc5_ * 0.91706;
   _loc2_.p5 = -0.39875;
   _loc2_.p6 = _loc4_ * 0.39875;
   _loc2_.p7 = _loc5_ * 0.39875;
   _loc2_.p8 = 0.91706;
...
p.setRotationAngle = function(arg)
{
   ...
   var _loc4_ = Math.cos(arg);
   var _loc3_ = Math.sin(arg);
   var _loc2_ = this._c;
   _loc2_.r0 = _loc4_;
   _loc2_.r1 = - _loc3_;
...
{
   this.nightSide._yscale = this.nightSide._xscale = this.globe._yscale = this.globe._xscale = arg;
};
