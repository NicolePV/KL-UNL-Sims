function CelestialSphereClass()
{
   ...
   this.createEmptyMovieClip("_bEL",_loc2_ - 6);
   this.createEmptyMovieClip("_bOSB",_loc2_ - 5);
   this.createEmptyMovieClip("_bOSA",_loc2_ - 4);
   this.createEmptyMovieClip("_bOSF",_loc2_ - 3);
   this.createEmptyMovieClip("_bF",_loc2_ - 2);
   ...
   this.createEmptyMovieClip("_iLA",4 * _loc2_ - 6);
   this.createEmptyMovieClip("_fISB",4 * _loc2_ - 5);
   this.createEmptyMovieClip("_fISA",4 * _loc2_ - 4);
   this.createEmptyMovieClip("_fISF",4 * _loc2_ - 3);
   this.createEmptyMovieClip("_fF",4 * _loc2_ - 2);
