MovieClip.prototype.maxArcStep = 0.2;
MovieClip.prototype.drawArc = function(x, y, radius, startAngle, endAngle)
{
   ...
   var _loc15_ = endAngle - startAngle;
   if(_loc15_ < 0)
   {
      _loc15_ = 6.283185307179586 + _loc15_;
   }
   var _loc13_ = Math.ceil(_loc15_ / this.maxArcStep);
   var _loc8_ = _loc15_ / _loc13_;
