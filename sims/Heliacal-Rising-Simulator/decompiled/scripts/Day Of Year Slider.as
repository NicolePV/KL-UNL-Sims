function DayOfYearSliderClass()
{
   ...
   {
      var _loc1_ = this;
      _loc1_._parent._parent.setDayOfYearZB((_loc1_._parent._xmouse - _loc1_.offset) / _loc1_._parent.scaleFactor - 0.5,true);
      updateAfterEvent();
   };
...
{
   this._parent.setDayOfYearZB(this._parent.dayOfYearZB + arg,true);
};
