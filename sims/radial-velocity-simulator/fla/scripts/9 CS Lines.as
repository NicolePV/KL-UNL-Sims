...
p.getShowLines = function()
{
   return this._bEL._visible;
};
p.setShowLines = function(arg)
{
   this._bEL._visible = this._fEL._visible = this._iLA._visible = this._iLB._visible = arg;
   if(arg)
   {
      this.updateLines();
   }
};
p.addProperty("showLines",p.getShowLines,p.setShowLines);
p.setLineVisibility = function(arg)
{
