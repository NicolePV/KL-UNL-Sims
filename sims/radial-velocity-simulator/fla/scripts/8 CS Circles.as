...
p.getShowCircles = function()
{
   return this._bC._visible;
};
p.setShowCircles = function(arg)
{
   this._fC._visible = this._bC._visible = arg;
   if(arg)
   {
      this.updateCircles();
   }
};
p.addProperty("showCircles",p.getShowCircles,p.setShowCircles);
p.setCircleVisibility = function(arg)
{
   var list = this._circleList;
   var i = 0;
   while(i < list.length)
   {
      list[i].name.visible = arg;
      i++;
   }
};
...
p.setArcPoints = function(point1, point2)
{
   if(typeof point1 == "string")
   {
      var obj = this._parent[point1];
      if(!(obj instanceof CSObjectsClass))
      {
         return false;
      }
      var p1 = {x:obj._p.x,y:obj._p.y,z:obj._p.z};
      if(obj._sys == 1)
      {
         p1.sys = 1;
         p1.system = "celestial";
   ...
   {
      var p1 = {};
      this._parent.parsePointInput(point1,p1);
      if(p1.sys == null)
      {
         return false;
      }
   ...
   {
      var obj = this._parent[point2];
      if(!(obj instanceof CSObjectsClass))
      {
         return false;
      }
      var p2 = {x:obj._p.x,y:obj._p.y,z:obj._p.z};
      if(obj._sys == 1)
      {
         p2.system = "celestial";
      }
   ...
   if(p1.sys == 1)
   {
      ...
      var cp1 = {};
      var cp2 = {};
      this._parent.pointToCelestial(p1,cp1);
      this._parent.pointToCelestial(p2,cp2);
      if(cp1.ra == null || cp2.ra == null)
      {
         return false;
      }
      var theta1 = cp1.ra * 0.2617993877991494;
      var phi1 = cp1.dec * 0.017453292519943295;
      var theta2 = cp2.ra * 0.2617993877991494;
      var phi2 = cp2.dec * 0.017453292519943295;
   }
   else
   {
      this._sys = 0;
      var hp1 = {};
      var hp2 = {};
      this._parent.pointToHorizon(p1,hp1);
      this._parent.pointToHorizon(p2,hp2);
      if(hp1.az == null || hp2.az == null)
      {
         return false;
      }
      var theta1 = (360 - hp1.az) * 0.017453292519943295;
      var phi1 = hp1.alt * 0.017453292519943295;
      var theta2 = (360 - hp2.az) * 0.017453292519943295;
      var phi2 = hp2.alt * 0.017453292519943295;
   }
