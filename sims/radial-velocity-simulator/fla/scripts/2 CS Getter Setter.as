...
p.setViewerAzAndAlt = function(newAz, newAlt)
{
   this.setThetaAndPhi(360 - newAz,newAlt);
};
p.setViewerAltAndAz = function(newAlt, newAz)
{
   this.setThetaAndPhi(360 - newAz,newAlt);
};
p.setThetaAndPhi = function(newTheta, newPhi)
{
   ...
   {
      this._iLA.swapDepths(4 * this._N - 7);
   }
   this.doA();
   this.doB();
