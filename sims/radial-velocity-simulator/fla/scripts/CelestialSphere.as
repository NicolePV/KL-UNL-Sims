function CelestialSphereClass()
{
   ...
   this.createEmptyMovieClip("_bEL",N - 7);
   this.createEmptyMovieClip("_bOSB",N - 6);
   this.createEmptyMovieClip("_bOSA",N - 5);
   this.createEmptyMovieClip("_bOSF",N - 4);
   this.createEmptyMovieClip("_bF",N - 3);
   this.createEmptyMovieClip("_bDT",N - 2);
   ...
   this.createEmptyMovieClip("_iLA",4 * N - 7);
   this.createEmptyMovieClip("_fISB",4 * N - 6);
   this.createEmptyMovieClip("_fISA",4 * N - 5);
   this.createEmptyMovieClip("_fISF",4 * N - 4);
   this.createEmptyMovieClip("_fF",4 * N - 3);
   this.createEmptyMovieClip("_fDT",4 * N - 2);
